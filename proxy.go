...
func handleRequest(w http.ResponseWriter, r *http.Request) { //nolint:gocognit,cyclop // request dispatcher; complexity is inherent to the auth+policy+routing pipeline
	start := time.Now()
