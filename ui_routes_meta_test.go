...
//   - 246 — Added /api/config/rollback-scope (GET viewer: which operator-facing
//     settings a config version rollback deliberately never captures/applies,
//     previously only discoverable by reading config_surfaces.go source).
