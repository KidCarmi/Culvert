...
func (e Event) validateFieldBounds() error {
	for _, s := range []string{
		...
		e.Decision.ShadowOutcome, e.Decision.ShadowCredentialPlan, e.Decision.ShadowMaterializeReady,
		e.Decision.ShadowRequestInspection, e.Decision.ShadowResponseInspection,
