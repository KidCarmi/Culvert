...
policy.go     — Policy engine: rule evaluation, FQDN/category/GeoIP/schedule matching (URL-category store → internal/urlcat per ADR-0002; two-tier matchCategory/lookupHostCategory fusion stays here)
