...
| Design | `THREAT-MODEL.md` (STRIDE, attack tree, residual risk) + [`docs/adr/0024`](../../adr/0024-mcp-agent-security-gateway-trust-boundary.md) (trust-boundary decision + D-2/D-5/D-8/D-9/D-13 closures, `Status: Proposed`) | [Normative project requirement] | Design review sign-off; **ratification of ADR-0024 to Accepted (ARB + Security Architecture)** is the hard PR-1 entry gate | Sec / Eng / Architecture | PR-0 (artifact), PR-1 (ADR-0024 must be Accepted before PR-1 lands) |
