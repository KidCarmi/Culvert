...
def seed_wrong_req_total(t):
    return _mut(t, 'traceability',
                lambda s: s.replace('**97 requirements**', '**95 requirements**', 1))


def seed_wrong_family_count(t):
    return _mut(t, 'requirements',
                lambda s: s.replace('MCP-PROTO 17', 'MCP-PROTO 15', 1))
...
def seed_duplicate_req_total(t):
    return _mut(t, 'requirements',
                lambda s: s.replace('**Total requirements: 97**',
                                    '**Total requirements: 97** **Total requirements: 97**', 1))
...
def seed_wrong_threat_total(t):
    return _mut(t, 'traceability',
                lambda s: s.replace('**78 threats**', '**76 threats**', 1))


def seed_duplicate_threat_total(t):
    return _mut(t, 'traceability',
                lambda s: s.replace('**78 threats**', '**78 threats** **78 threats**', 1))
...
def seed_first_match_laundering(t):
    ...
    return _mut(t, 'requirements',
                lambda s: s.replace('**Total requirements: 97**',
                                    '**Total requirements: 97** (see also **Total requirements: 91**)', 1))
