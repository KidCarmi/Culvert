...
| 3 | Full supported-API coverage (document all supported endpoints; retire exemptions) | **IN PROGRESS** — 223/284 documented (read surface complete across all domains; first write endpoints documented with request-conformance tests), 61 exempt remaining |
