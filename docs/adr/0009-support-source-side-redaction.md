# ADR-0009: Source-side redaction & a data-classification registry for support data
...
- **Relates to:** ADR-0007 (secret containment — the `NEVER_EXPORT` enforcement), ADR-0008 (bundle framework), `config_surfaces.go` (the existing classification pattern). Full design in `docs/support/REDACTION-MODEL.md`.
