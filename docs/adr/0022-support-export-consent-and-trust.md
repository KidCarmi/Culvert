# ADR-0022: Support export/upload consent & trust model; remote support deferred
...
- **Relates to:** ADR-0019 (bundle framework), ADR-0020 (redaction), `internal/backupcrypt`, `internal/ssrf`, the release-catalog trust/origin model. Full design in `docs/support/SECURE-UPLOAD-ARCHITECTURE.md`.
