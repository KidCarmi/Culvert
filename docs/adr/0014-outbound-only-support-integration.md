...
- **Relates to:** ADR-0012 (cloud-first), ADR-0015 (cloud independence), ADR-0022 (export/consent). Basis: `docs/support/SECURE-UPLOAD-ARCHITECTURE.md`, `TAC-CLOUD-ARCHITECTURE.md`.
