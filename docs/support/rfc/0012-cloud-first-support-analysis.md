...
- **Relates to:** ADR-0028 (bundle framework), ADR-0013 (no local analyzer), ADR-0014 (outbound-only), ADR-0015 (cloud independence). Decision basis: `docs/support/ANALYSIS-MODEL-DECISION.md`.
