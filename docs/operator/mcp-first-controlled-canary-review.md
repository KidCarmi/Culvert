...
| Campaign | `scripts/mcp-first-canary-catalog-usable-mutations.sh` — 20 mutations, 20 caught, 0 survived, 0 skipped |
...
The repaired campaign scores **20 caught, 0 survived, 0 skipped** on the closing head. M15 through
M20 were added later, for the six defects adversarial review found on the PR itself (passive
