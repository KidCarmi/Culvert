...
> The campaign then grew four times — to 17, and once per review finding after that: M18 (round 1),
> M19 (round 2), M20 (round 3) — so each earlier score described a campaign that no longer existed.
